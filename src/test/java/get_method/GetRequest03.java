...
import static org.hamcrest.Matchers.*;//we put .* here so as to not use matchers over and over again
//we put static because we dont need unstatic ones. we use static ones with class name
//when import is grey it is not used so far
